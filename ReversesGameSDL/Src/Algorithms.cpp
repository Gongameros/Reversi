...
std::vector<std::vector<int>> AlgorithmChanging(int color, int index_for_place)
{
    ...
    //ïåðåâ³ðêà ÷è ïóñòà êë³òèíêà
    if (matrix[x][y] == 0) {
        //ïåðåâ³ðêè ÷è âàë³äí³ çíà÷åííÿ
        bool is_valid = false;
        //ïåðåâ³ðêà ïî âåðòèêàë³ âíèç
        ...
        //ïåðåâ³ðêà ïî ãîðèçîíòàë³ âïðàâî
        ...
        if (y > 1 && matrix[x][y - 1] != 0) {
            ...
            while (y_copy != -1) {
                ...
                y_copy--;
                    ...
                    //перевірка по діагоналі вліво вгору
            ...
            //перевірка по діагоналі вправо вгору
            ...
            //перевірка по діагоналі вправо вниз
            ...
            //перевірка по діагоналі вліво вниз
